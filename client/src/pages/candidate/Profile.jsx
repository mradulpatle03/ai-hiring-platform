          ...
          <div style={s.card}>
            ...
            <div style={s.boostBox}>
              <div style={s.boostTxt}>
                <strong>Tip:</strong> Connecting your GitHub can boost your
                AI match score by up to 30 points. Recruiters love seeing real
                code activity.
              </div>
            </div>
            ...
            {[
              {
                icon: <User size={14} color="#7F77DD" />,
                label: "Name",
                value: user?.name,
              },
              {
                icon: <Mail size={14} color="#7F77DD" />,
                label: "Email",
                value: user?.email,
              },
              {
                icon: <Building size={14} color="#7F77DD" />,
                label: "Role",
                value: "Candidate",
              },
